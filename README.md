...
Nota: Para evaluar funcionalidad completa asegúrate de ejecutar `npm install` en ambos proyectos y tener MongoDB disponible o usar la configuración por defecto.
